...
from ..nn_models import build_backward, build_forward, build_actor, eval_mode, build_simple_critic, build_hierarchical_actor, build_simple_actor
...
class FBModel(nn.Module):
    def __init__(self, **kwargs):
        ...
        self._actor = build_simple_actor(obs_dim, action_dim, arch.actor)
