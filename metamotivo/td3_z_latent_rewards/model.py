...
from ..nn_models import build_backward, build_forward, build_actor, eval_mode, build_simple_critic, build_hierarchical_actor
...
class FBModel(nn.Module):
    def __init__(self, **kwargs):
        ...
        self._hierarchical_actor = build_hierarchical_actor(arch.z_dim)
    ...
    # @torch.no_grad()
    def hierarchical_actor(self, obs: torch.Tensor):
        return self._hierarchical_actor(self._normalize(obs))
