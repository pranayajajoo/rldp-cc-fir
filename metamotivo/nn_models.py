...
def build_encoder(obs_dim, action_dim, zs_dim, za_dim, zsa_dim, cfg):
    return EncoderMap(obs_dim, action_dim, zs_dim, za_dim, zsa_dim, cfg.hidden_dim, cfg.enc_horizon, cfg.hidden_layers, cfg.norm)
...
class EncoderMap(nn.Module):
    def __init__(self, goal_dim, action_dim, zs_dim, za_dim,zsa_dim, hidden_dim, enc_horizon, hidden_layers: int = 2, norm=True) -> None:
        super().__init__()
