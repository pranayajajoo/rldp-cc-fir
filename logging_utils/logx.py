...
import warnings
# from logging_utils.mpi_tools import proc_id, mpi_statistics_scalar
from logging_utils.serialization_utils import convert_json
...
class EpochLogger(Logger):
    ...
    def stats_scalar(vals, with_min_and_max=False):
        if with_min_and_max:
