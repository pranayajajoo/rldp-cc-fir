...
SBATCH_OPTIONS = {
    "job_name": "mr",  # Base job name
    "time": "48:00:00",                     # Time limit (HH:MM:SS)
    "partition": "gh",                     # Partition name
    "nodes": 1,                            # 1 node
...
# Path configurations
EXPERIMENT_NAME = "MR_total_3m_v1_dim_ablate"
DATASET_ROOT = "/work/09313/hsikchi/vista/work/exorl/datasets"
WORK_DIR_BASE = "/work/09313/hsikchi/vista/work/metamotivo/results/"+EXPERIMENT_NAME
SCRIPT_PATH = "examples/mr_train_dmc.py"

# New Configurations
CODEBASE_DIR = "/work/09313/hsikchi/vista/work/metamotivo"
CONDA_PATH = "/work/09313/hsikchi/vista/miniconda3/etc/profile.d/conda.sh"  # Typically, conda.sh is located here
CONDA_ENV = "motivo"   # Conda environment name
...
def construct_command(domain, task, hyperparams):
    ...
    commands.append('export PYTHONPATH="${PYTHONPATH}:/work/09313/hsikchi/vista/work/metamotivo"')
